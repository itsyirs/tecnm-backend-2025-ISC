...
public class ProductoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizarProducto(@PathVariable int id, @RequestBody PUTProductoDTO producto) {
        Producto productoActualizado = productoDAO.actualizarProducto(id, producto);
