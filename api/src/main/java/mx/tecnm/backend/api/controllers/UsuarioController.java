...
public class UsuarioController 
{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizarUsuario(@PathVariable int id, @RequestBody UsuarioDTO usuario) {
        Usuario usuarioActualizado = usuarioDAO.actualizarUsuario(id, usuario);
