...
public class EnvioDAO {
    ...
    public Envio insertarEnvio(Envio envio) {
        int filas = jdbcClient.sql("INSERT INTO envios(fecha_entrega, fecha_envio, estado, numero_seguimiento, domicilios_id, pedidos_id) VALUES (:fecha_entrega, :fecha_envio, :estado, :numero_seguimiento, :domicilios_id, :pedidos_id) RETURNING id")
            ...
            .single();
        return obtenerEnvioPorId(filas);
    }
    public Envio actualizarEnvio(int id, Envio envio) {
        int filas = jdbcClient.sql("UPDATE envios SET fecha_entrega=:fecha_entrega, fecha_envio=:fecha_envio, estado=:estado, numero_seguimiento=:numero_seguimiento, domicilios_id=:domicilios_id, pedidos_id=:pedidos_id WHERE id=:id RETURNING id")
            .param("id", id)
            .param("fecha_entrega", envio.fecha_entrega())
            .param("fecha_envio", envio.fecha_envio())
            .param("estado", envio.estado().name())
